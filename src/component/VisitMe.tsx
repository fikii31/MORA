import './VisitMe.css';
import Lokasi from '../assets/Location.jpg';
import 'bootstrap-icons/font/bootstrap-icons.css'

const VisitMe = () => {
  return (
    <section className="visit-section" id="VisitMe">
        <div className="visit-container">
            <h2 className="visit-title">Visit Us</h2>
            <p className="visit-description">
                Come experience the warm and inviting atmosphere of MORA Kafe. Whether you're stopping by for your morning coffee or meeting friends for an afternoon treat, our doors are always open to welcome you.
            </p>
        ...
        <div className="visit-image">
            <img src={Lokasi} alt="MORA Kafe Location" className="visit-image" loading='lazy' />
        </div>
